...
ENV TRADUORA_API_CLIENT_ID ${TRADUORA_API_CLIENT_ID}
ENV TRADUORA_API_CLIENT_SECRET ${TRADUORA_API_CLIENT_SECRET}
ENV TRADUORA_API_PROJECT_ID ${TRADUORA_API_PROJECT_ID}
